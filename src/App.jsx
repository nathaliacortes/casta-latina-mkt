                        ...
                        <div style={{display:"flex",alignItems:"center",gap:8}}>
                          <div style={{textAlign:"center"}}>
                            <button onClick={()=>toggleActivo(m.id)}
                              style={{padding:"3px 9px",borderRadius:20,background:m.activo?"#F0FDF4":"#F8FAFC",color:m.activo?"#3BAD6E":"#94A3B8",fontSize:10,fontWeight:700,cursor:"pointer",fontFamily:"inherit",border:`1px solid ${m.activo?"#A7F3D0":"#E2E8F0"}`}}>
